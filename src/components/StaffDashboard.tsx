...
const StaffDashboard: React.FC<StaffDashboardProps> = ({ user, onLogout }) => {
  ...
  // Mock orders data for this specific location
  ...
  // Mock drivers data for this location
  const [drivers, setDrivers] = useState<Driver[]>([
    {
      ...
      phone: '044123456',
      status: 'ne_delivery',
      currentLocation: 'Prishtinë Qendër',
      activeDeliveries: 1,
      assignedLocation: '1'
    },
    {
      ...
      phone: '049789012',
      status: 'ne_delivery',
      currentLocation: 'Prishtinë Lindje',
      activeDeliveries: 1,
      assignedLocation: '1'
    },
    {
  ...
  const assignOrderToDriver = (driverId: string) => {
    ...
    setDrivers(prev => prev.map(driver => 
      driver.id === driverId ? { ...driver, status: 'ne_delivery', activeDeliveries: 1 } : driver
    ));
    
    alert(`Porosia #${selectedOrder.orderNumber} u caktua tek shoferi ${driver.name}!`);
                        ...
                        {orders.map((order) => (
                          <tr key={order.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                              {order.assignedDriver ? order.assignedDriver.name : '-'}
                            </td>
                           ...
                           {konfirmuarOrders.map((order) => (
                             <div key={order.id} className="bg-white p-4 rounded-lg shadow-sm">
                               ...
                               <div className="text-xs text-blue-600 font-medium">
                                 Shoferi: {order.assignedDriver?.name}
                               </div>
                             </div>
                           ))}
                         </div>
                  ...
                  <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Dorëzime aktive</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Aksionet</th>
                      </tr>
                    </thead>
                    <tbody className="bg-white divide-y divide-gray-200">
                  ...
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <div className="mt-4">
                      <div className="flex justify-between text-sm">
                        <span>Pranuar: 3</span>
                        <span>Konfirmuar: 2</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Në delivery: 2</span>
                        <span>Përfunduar: 1</span>
                      </div>
                    </div>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-6">
                    <h3 className="text-md font-medium text-gray-900 mb-4">Dje</h3>
                    <div className="text-3xl font-bold text-green-600">12</div>
                    <p className="text-sm text-gray-600 mt-2">Porosi totale</p>
                    <div className="mt-4">
                      <div className="flex justify-between text-sm">
                        <span>Pranuar: 4</span>
                        <span>Konfirmuar: 3</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Në delivery: 3</span>
                        <span>Përfunduar: 2</span>
                      </div>
                    </div>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-6">
                    <h3 className="text-md font-medium text-gray-900 mb-4">Këtë javë</h3>
                    <div className="text-3xl font-bold text-green-600">45</div>
                    <p className="text-sm text-gray-600 mt-2">Porosi totale</p>
                    <div className="mt-4">
                      <div className="flex justify-between text-sm">
                        <span>E hënë: 8</span>
                        <span>E martë: 12</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>E mërkurë: 15</span>
                        <span>E enjte: 10</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-medium text-gray-900">Cakto shofer për porosinë #{selectedOrder.orderNumber}</h3>
                <button
              ...
              <div className="mb-4">
                <p className="text-sm text-gray-600 mb-2">Klienti: {selectedOrder.customerName}</p>
